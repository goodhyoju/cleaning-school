<head>
    ...
    <link rel="stylesheet" type="text/css" href="lib/colorPick/colorPick.css" />
    <link rel="stylesheet" type="text/css" href="lib/colorPick/colorPick.dark.theme.css" />
